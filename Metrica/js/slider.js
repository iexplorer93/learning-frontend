...
const slidesNodes = Array.from(document.querySelectorAll('.galery-section__slide'));
console.log(slidesNodes);
const prevButtonNode = document.querySelector('.galery-section__control--prev');
const nextButtonNode = document.querySelector('.galery-section__control--next');
let activeId;
